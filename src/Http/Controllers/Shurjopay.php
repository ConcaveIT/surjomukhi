 ...
 * Inside the controller some traits are used called "PreparePayloadService,GetIpService;
 * CurlRequestService,CreateLogService,ExceptionInfoService,CheckTokenExpiredService & CheckInternetService"
 * prepareCurlRequest(),prepareTransactionPayload(),checkInternetConnection()
    ...
    public function authenticate()
    {
        ...
        if ($this->checkInternetConnection()) {
            ...
            # Catching ShurjopayException custom exception and throwing it to ShurjopayException
                ...
                throw new ShurjopayException("Exception occured into makePayment() !", 0, $e);
            }
            # Catching BadMethodCallException custom exception and throwing it to ShurjopayException
                ...
                throw new ShurjopayException("BadMethodCallException occured into makePayment().Kindly check method name", 0, $e);
            }
            # Catching ArgumentCountError custom exception and throwing it to ShurjopayException
                ...
                throw new ShurjopayException("ArgumentCountError occured into makePayment().Kindly check number of passing perameters", 0, $e);
            }
            # Catching InvalidArgumentException custom exception and throwing it to ShurjopayException
                ...
                throw new ShurjopayException("InvalidArgumentException occured into makePayment().Kindly check type of passing aurguments at perameters", 0, $e);
            }
             catch (\Exception $e) {
                $this->createLog("Exception occured into makePayment() !");
                throw new ShurjopayException("Please make your code correct,first",0,$e);
            }catch (\Error $e) {
                $this->createLog("Fatal error occured into makePayment() !");
                throw new ShurjopayException("Please resolve fatal error to make a payment ,first",0,$e);
            }
        }
        ...
        if ($this->checkInternetConnection()) {
            ...
            if (!empty($authentication_data->sp_code) && ($authentication_data->sp_code) == '200')
            {
                ...
                # If any exception occur in try block then that will be caught here and thrown to ShurjopayException
                    ...
                    $this->createLog("Exception occured into verifyPayment() !");
                    throw new ShurjopayException("Exception occured into verifyPayment() !", 0, $e);
                }
            }
