...
trait ExceptionInfoService{
    ...
    public function exceptionInfo($message,$e){
        ...
        $shurjopay_says=$message;
        $problem_file_name = $e->getFile();
        $problem_LineNumber= $e->getLine();
        $myResponse=["laravel_error_msg" => $laravel_error_msg,"shurjopay_says"=>$shurjopay_says, "problem_file_name" => $problem_file_name,"problem_LineNumber"=>$problem_LineNumber];
