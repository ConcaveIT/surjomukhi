...
trait CreateLogService{
    ...
    public function createLog( $message )
     ...
     {
        /**
         * "sp_log()" is a service method
         *  This function is used to creating logging records according versions of laravel and making directory for
         *  logging if file not exist.
         */
